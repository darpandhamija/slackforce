...
exports.handle = (req, res) => {
    ...
    fields.push({title: "`/removeFromCadence`", value: "Remove Target from Sales Cadence", short: false});
    fields.push({title: "`/makeACall`", value: "(Coming Soon) Make a Call and Advance Cadence", short: false});
    fields.push({title: "`/sendAnEmail`", value: "(Coming Soon) Send an Email and Advance Cadence", short: false});
